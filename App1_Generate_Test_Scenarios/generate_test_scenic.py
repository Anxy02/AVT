...
# openai.base_url = "https://openkey.cloud"
# openai.base_url = "https://api.ohmygpt.com"
# openai.organization = "org-CngjJlmDH6yXeLciASZTVYi4"
...
def getanswer(R, Q):
    response = openai.completions.create(
        # engine="text-davinci-002",    "gpt-3.5-turbo-0125"
